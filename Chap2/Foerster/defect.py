...
plot_dict['122']={
    'A':{'type':'scatter','y':h[0].to_json(),'label':u'$(n-1)P_{3/2}(n-2)P_{3/2}$','xlabel':u'Hauptquantenzahl $n$','xlim':(45,120),'ylim':(-0.5,0.5)},                
    'B':{'type':'scatter','y':h2[0].to_json(),'label':u'$(n-1)P_{1/2}(n-2)P_{3/2}$'},
